...
const MainContainer = () => {
  ...
  return (
    <div className='flex items-center justify-center align-middle h-screen flex-col font-sans box-border text-teal-400'>
      <WelcomeDisplay />
      ...
      <SelectHabitDisplay handleSelectOptionChange={handleSelectOptionChange} habits={habits} makeRequest={makeRequest} />
